...
<html lang="en">
	<head>
		...
		<title>UnlimitedStore | Home</title>
		...
		<link href="{{asset('site/css/jquery.smartmenus.bootstrap.css')}}" rel="stylesheet">
		<!-- Product view slider -->
		<link rel="stylesheet" type="text/css" href="{{asset('site/css/jquery.simpleLens.css')}}">    
		<!-- slick slider -->
		<link rel="stylesheet" type="text/css" href="{{asset('site/css/slick.css')}}">
		<!-- price picker slider -->
		<link rel="stylesheet" type="text/css" href="{{asset('site/css/nouislider.css')}}">
		<!-- Theme color -->
		<link id="switcher" href="{{asset('site/css/theme-color/default-theme.css')}}" rel="stylesheet">
		<!-- <link id="switcher" href="css/theme-color/bridge-theme.css" rel="stylesheet"> -->
		<!-- Top Slider CSS -->
		<link href="{{asset('site/css/sequence-theme.modern-slide-in.css')}}" rel="stylesheet" media="all">
	...
	<script type="text/javascript" src="{{asset('site/js/jquery.smartmenus.js')}}"></script>
	<!-- SmartMenus jQuery Bootstrap Addon -->
	<script type="text/javascript" src="{{asset('site/js/jquery.smartmenus.bootstrap.js')}}"></script>  
	<!-- To Slider JS -->
	<script src="{{asset('site/js/sequence.js')}}"></script>
	<script src="{{asset('site/js/sequence-theme.modern-slide-in.js')}}"></script>  
	<!-- Product view slider -->
	<script type="text/javascript" src="{{asset('site/js/jquery.simpleGallery.js')}}"></script>
	<script type="text/javascript" src="{{asset('site/js/jquery.simpleLens.js')}}"></script>
	<!-- slick slider -->
	<script type="text/javascript" src="{{asset('site/js/slick.js')}}"></script>
	<!-- Price picker slider -->
	<script type="text/javascript" src="{{asset('site/js/nouislider.js')}}"></script>
	<!-- Custom js -->
